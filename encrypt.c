...
int times_syndrome;
int times_syndrome_tohost;
int times_syndrome_tokern;

double sum_syndrome_kernels;
int times_syndrome_kernels;

double sum_total_syndrome;
int times_total_syndrome;
...
//int syndrome_host(unsigned char *s, const unsigned char *pk, unsigned char  *e) //ap_uint<PACK_BITWIDTH_E>
//{
//
