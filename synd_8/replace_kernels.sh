...
do
    ...
    sed  -e "s+/$2+/$1+g" -e  "s/$2_$2/$1_$kernel_num/g" -e  "s+$2\*+$kernel_num\*+g" -e "s+$prev_mult\*+$prev_idx\*+g" -e"s/gmem3/gmem$gmem_idx/g"  synd_kernel$2_$2.c > synd_kernel$1_$kernel_num.c
    echo "test_kernel_$1_$kernel_num"
done